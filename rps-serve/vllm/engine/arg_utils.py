...
class EngineArgs:
    ...
    slo_registry_files: list[str] = Field(default_factory=list)
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument(
            ...
            type=str,
            default=None,
            help="Request classifier to be used",
        )
        ...
        parser.add_argument(
            ...
            nargs="+",
            default=[],
            help="One or more paths to JSONL files containing request SLO data.",
        )
        return parser
    ...
    def create_engine_config(
        ...
        config = VllmConfig(
            ...
            slo_registry_files=self.slo_registry_files,
        )
